class Particle {
    ...
    checkMaxEdgeX(w){
        if(this.innWidth < this.pos.x + this.diagX + this.vel + w){
    ...
    checkMaxEdgeY(h){
        if(this.innHeight < this.pos.y + this.diagY + this.vel + h){
            return true;
        }
